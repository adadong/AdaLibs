 ...
 */
public class MyAutoCompleteTextView extends RelativeLayout implements
...
//                leftDrawable.getIntrinsicHeight()-20);
        ...
        tv.setCompoundDrawables(leftDrawable, null, mClearDrawable, null);
...
//    }
    ...
    public void setClearIconVisible(boolean visible) {
        if(visible){
            ...
            mClearDrawable = tv.getCompoundDrawables()[2];
            if (mClearDrawable == null) {
                mClearDrawable = getResources().getDrawable(
                        R.drawable.input_clear);
            }
